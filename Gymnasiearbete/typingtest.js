...
const ord = document.getElementById(".ordSkrivna");
...
input.addEventListener("keydown", function (e) {
    ...
    if (bokstav == " ") {
        ...
        if (ordArray[0] == ordet) {
            ...
            ordArray.shift();
            ord++;
            document.querySelector("#countDown").innerHTML = ord
...
btn.addEventListener("click", () => {
    ...
    else if (output.textContent === mening2) {
        output.textContent = mening3
        ordArray = output.textContent.split(" ");
